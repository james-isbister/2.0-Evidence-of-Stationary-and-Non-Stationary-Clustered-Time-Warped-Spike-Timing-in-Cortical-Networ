...
Such correlated clusters were observed in a large number of first spike pair distributions (Supplementary Vid. 1) and represent reliable regions of the response distribution space that can be analysed to test the nature of spike timing noise correlations. The correlative structure could be caused by neural adaptation, a continuous non-adaptative latent state or a combination of the two.

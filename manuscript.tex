...
The neural coding problem addresses the question of how information is encoded by patterns of action potentials in the nervous system \cite{gerstner1997neural, johnson2000neural, stein2005neuronal, gerstner2014neuronal}. Whilst precise temporal spike patterns have been observed \cite{uzzell2004precision, johansson2004first, gollisch2008rapid, storchi2012comparison, reinagel2002precise, reyes2014laminar}, a large proportion of spike time variability remains unexplained. Such variability leads to the common assumption of population spike count \cite{reyes2015high, lin2015nature} or trial-averaged firing rate \cite{hong2016explicit, chang2017code, kar2019evidence, stringer2019high} codes. Previous studies have shown that spike count variability is shared across the population \cite{scholvinck2015cortical, lin2015nature}. As single cortical neurons can generate highly reliable spike trains to direct stimulation in vitro \cite{mainen1995reliability}, in vivo shared variability is likely to arise from variability in synaptic inputs, reflecting cortical network dynamics \cite{carandini2004amplification}. 

In early visual cortex, trial-to-trial spike count variability is correlated across the population and shown to be modulated by two global factors, which fluctuate the level of excitability from trial-to-trial \cite{lin2015nature}. Firstly, an additive factor is explained by the interaction of evoked activity with population-wide spontaneous activity \cite{arieli1996dynamics, scholvinck2015cortical}. A second multiplicative factor also modulates the trial-to-trial fluctuation in excitability across the population, and has been proposed to be caused by top-down modulation... Fluctuations in spontaneous activity have also been shown to gate sensory-evoked responses \cite{luczak2013gating}. 

Fluctuations in trial-to-trial excitability are referred to herein as trial-to-trial fluctuations in continuous cortical state \cite{scholvinck2015cortical}, which may be multi-dimensional and can be separated into short and long-timescale fluctuations. In this paper, long-timescale refer to large changes taking place over multiple trials that are caused by neural adaptation in response to repetitive stimulation or possibly due to changes in the level of anaesthesia. Short-timescale fluctuations refer to random trial-to-trial fluctuations in excitability around the current general level of excitability.

% Other studies have reported only weak spike count correlations in sensory cortices \cite{reyes2015high}.

Rather than spike count noise correlations, this study aims to characterise the nature of trial-to-trial spike time noise correlations as a step towards confirming or rejecting the modulation of spike times by short-timescale fluctuations of a low-dimensional continuous cortical state. This offers a novel prediction of the encoding capacity of state-dependent spike time encoding, which controls for longer timescale changes in excitability such as neural adaptation. 

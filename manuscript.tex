...
\todo{Look at adaptation by neuron type and layer}
\todo{Select final adaptation examples, with layers and stats.}
\todo{Do adaptation conclusion}
\todo{Make adaptation stats overview paragraph simpler, with nice single bar chart}
...
% Moreover, very few different stimuli could be encoded with high-discriminability. 
...
The factor correlation matrix of each stationary Stage 2 clusters had only one eigenvalue greater than 1, suggesting that a single factor underlied each cluster correlation.
